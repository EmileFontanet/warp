...
def load_star_params():
    ...
    cols = ['HD', 'Stype', 'V', 'V_e', 'B-V', 'B-V_e', 'BC', 'BC_e', 'pi', 'pi_e', 'd', 'd_e', 'd_E', 'Mv', 'Mv_e', 'Bp-Rp', 'Bp-Rp_e',
            'G', 'G_e', 'Teff', 'Teff_err', 'logg', 'logg_e', 'feh', 'feh_e', 'Mstar', 'Mstar_e', 'Lstar', 'Lstar_e', 'Rstar', 'Rstar_e']
...
def load_star_params_2():
    from astropy.table import Table
    file_path = os.path.join(os.path.dirname(__file__), "data", "table2.dat")
    readme_path = os.path.join(os.path.dirname(__file__), "data", "ReadMe")
    cols = ['HD', 'Stype', 'V', 'V_e', 'B-V', 'B-V_e', 'BC', 'BC_e', 'pi', 'pi_e', 'd', 'd_e', 'd_E', 'Mv', 'Mv_e', 'Bp-Rp', 'Bp-Rp_e',
            'G', 'G_e', 'Teff', 'Teff_err', 'logg', 'logg_e', 'feh', 'feh_e', 'Mstar', 'Mstar_e', 'Lstar', 'Lstar_e', 'Rstar', 'Rstar_e']

    t = Table.read(file_path, format="ascii.cds", readme=readme_path)
    df = t.to_pandas()
    cols_dict = {df.columns[i]: cols[i] for i in range(len(cols))}
