...
class Star:
    def __init__(self, name=None, instrument=None, load_rv=True, load_tess=False, max_erv=30,
                 do_adjust_means=False, do_secular_corr=True, skip_ndrs=False, keep_bad_qc=False, verbose=True,
    ...
    def plot_lightcurve(self, lc_file, detrend=False, show_raw=True, show_trend=True, ax=None, fig=None, save_fig=False, show_plot=False, smooth_days=10, **kwargs):
        from .plotting import plot_lightcurve
        if lc_file == 'all':
            lc_files = self.avlb_lightcurves
