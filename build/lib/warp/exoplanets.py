...
def is_planet_published(pl_names, planet_list=None, only_default=True):
    ...
    Args:
        ...
        only_default (bool): Whether to consider only default parameters.
    Returns:
    ...
    if planet_list is None:
        all_planets = fetch_nasa_archive(
            columns=['pl_name', 'pl_orbper', 'pl_refname', 'hostname'], only_default=only_default)
    else:
